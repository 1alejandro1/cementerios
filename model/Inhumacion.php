<?php
	...
	class Inhumacion {
		...
		public function Registrar($idcontrato,$iddifunto,$fechafallecimiento,$fechainhumacion,$idpersonal,$observaciones){
			...
			$sql = "INSERT INTO inhumacion (idcontrato,iddifunto,fechafallecimiento,fechainhumacion,idpersonal,observaciones,fecharegistro)

						VALUES($idcontrato,$iddifunto,'$fechafallecimiento','$fechainhumacion',$idpersonal,'$observaciones','$fecharegistro')";
		...
		public function Modificar($idinhumacion,$idcontrato,$iddifunto,$fechafallecimiento,$fechainhumacion,$idpersonal,$observaciones){

			global $conexion;

			$sql = "UPDATE inhumacion set idcontrato=$idcontrato, iddifunto=$iddifunto, fechafallecimiento='$fechafallecimiento', fechainhumacion='$fechainhumacion', idpersonal=$idpersonal, observaciones='$observaciones' 
...
*/
		...
		public function ListarInhumaciones() {
			...
			$sql = "select i.*, c.nrocontrato, c.fechacontrato, d.nombre as difunto, CONCAT(p.nombre,' ',p.apellidos) as personal, m.razonsocial as cementerio, s.nombre as sector, l.numero as lote, l.fila, l.columna  
				from inhumacion i left join difunto d on i.iddifunto = d.iddifunto 
					 left join personal p on i.idpersonal = p.idpersonal 
					 left join contrato c on i.idcontrato = c.idcontrato 
					 left join cementerio m on c.idcementerio = m.idcementerio 
